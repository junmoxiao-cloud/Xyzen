  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4">
        <DialogPanel
          from="top"
          className={`flex w-full flex-col ${maxWidth} ${minWidth} ${minHeight} ${maxHeight} space-y-4 rounded-sm border border-neutral-200/20 bg-white/95 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl dark:border-neutral-700/30 dark:bg-neutral-900/95 dark:shadow-black/40`}
        >
          {title && title.trim() !== "" ? (
